...
sim.save_trace("broadcast_trace.json")
print("Trace saved to broadcast_trace.json")
```
...
This creates `broadcast_trace.json` containing the execution trace.
...
- **Check**: File is valid JSON and generated by dapy Simulator
- **Try**: Re-run simulation and regenerate trace
- **Verify**: Use a JSON validator on the trace file
